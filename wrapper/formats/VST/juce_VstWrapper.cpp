...
BEGIN_JUCE_NAMESPACE
 extern void juce_callAnyTimersSynchronously();
  ...
  extern bool juce_dispatchNextMessageOnSystemQueue (bool returnIfNoPendingMessages);
 #endif
END_JUCE_NAMESPACE
...
public:
    ...
    ~SharedMessageThread()
    {
        ...
        DBG ("SharedMessageThread -- inside 1");

        JUCEApplication::quit ();

        DBG ("SharedMessageThread -- inside 3");

        waitForThreadToExit (5000);

        DBG ("SharedMessageThread -- inside 4");

        clearSingletonInstance();

        DBG ("SharedMessageThread -- inside 5");
    }
    ...
    void run()
    {
        ...
        DBG ("before dispatching messages");
        ...
        DBG ("after dispatching messages");
