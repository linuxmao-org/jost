...
#include "MidiPads.h"
#include "../../ui/plugins/midipads/MidiPadsPluginEditor.h"
...
//==============================================================================
void MidiPadsPlugin::getCurrentProgramStateInformation (JUCE_NAMESPACE::MemoryBlock& destData)
{
...
void MidiPadsPlugin::getStateInformation (juce::MemoryBlock &destData)
{
    // make sure the non-parameter settings are copied to the current program
    programs[curProgram].bghue = bghue;
    programs[curProgram].bgsat = bgsat;
