...
#include "formats/Standalone/juce_AudioFilterStreamer.cpp"
#include "formats/Standalone/juce_StandaloneFilterWindow.cpp"
...
public:
    ...
    void initialise (const String& commandLine)
    {
        ...
        // create the window
        window = new StandaloneFilterWindow (jostMainWindowName, config->getColour (T("mainBackground")));
...
#include "formats/VST/juce_VstWrapper.cpp"
