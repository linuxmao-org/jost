...
#ifndef __JUCETICE_JOST_VSTPLUGINEDITORCOMPONENT_HEADER__
#define __JUCETICE_JOST_VSTPLUGINEDITORCOMPONENT_HEADER__
...
#endif // __JUCETICE_JOST_VSTPLUGINEDITORCOMPONENT_HEADER__
