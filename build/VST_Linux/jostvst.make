...
ifeq ($(CONFIG),Release)
  BINDIR := ../../bin
  LIBDIR := ../../bin
  OBJDIR := ../../bin/intermediate/jostvstRelease
  OUTDIR := ../../bin
  CPPFLAGS := $(DEPFLAGS) -D "LINUX=1" -D "JUCETICE_USE_AMALGAMA=1" -D "JUCE_USE_XSHM=1" -D "JUCE_ALSA=1" -D "JUCE_JACK=1" -D "JOST_USE_VST=1" -D "JOST_USE_LADSPA=1" -D "JOST_USE_DSSI=1" -D "JOST_VST_PLUGIN=1" -D "NDEBUG=1" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../../juce" -I "../../../../juce/src" -I "../../../../wrapper" -I "../../wrapper" -I "../../../../vst/vstsdk2.3" -I "../../../../vst/vstsdk2.3/source/common" -I "../../../../vstsdk2.3" -I "../../../../vstsdk2.3/source/common" -I "../../vst/vstsdk2.3" -I "../../vst/vstsdk2.3/source/common" -I "../../vstsdk2.3" -I "../../vstsdk2.3/source/common" -I "/usr/include/vstsdk2.3" -I "/usr/include/vst" -I "../../src"
  CFLAGS += $(CPPFLAGS) $(TARGET_ARCH) -fPIC -fomit-frame-pointer -O2 -pipe -fvisibility=hidden -Wall
  CXXFLAGS += $(CFLAGS)
  LDFLAGS += -L$(BINDIR) -L$(LIBDIR) -shared -s -L"../../bin" -L"/usr/X11R6/lib/" -L"/usr/lib/" -lfreetype -lpthread -lrt -lX11 -lXext -lasound -ljack
  LDDEPS :=
  RESFLAGS := -D "LINUX=1" -D "JUCETICE_USE_AMALGAMA=1" -D "JUCE_USE_XSHM=1" -D "JUCE_ALSA=1" -D "JUCE_JACK=1" -D "JOST_USE_VST=1" -D "JOST_USE_LADSPA=1" -D "JOST_USE_DSSI=1" -D "JOST_VST_PLUGIN=1" -D "NDEBUG=1" -I "/usr/include" -I "/usr/include/freetype2" -I "../../../../juce" -I "../../../../juce/src" -I "../../../../wrapper" -I "../../wrapper" -I "../../../../vst/vstsdk2.3" -I "../../../../vst/vstsdk2.3/source/common" -I "../../../../vstsdk2.3" -I "../../../../vstsdk2.3/source/common" -I "../../vst/vstsdk2.3" -I "../../vst/vstsdk2.3/source/common" -I "../../vstsdk2.3" -I "../../vstsdk2.3/source/common" -I "/usr/include/vstsdk2.3" -I "/usr/include/vst" -I "../../src"
  TARGET := jostvst.so
 BLDCMD = $(CXX) -o $(OUTDIR)/$(TARGET) $(OBJECTS) $(LDFLAGS) $(RESOURCES) $(TARGET_ARCH)
